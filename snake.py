...
class Snake:
    def __init__(self):
        ...
        for x, y in self.coordinates:  # list of squares
...
def next_turn(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        del snake.coordinates[-1]  # deleting previous squares from snake body
    ...
    if check_collision(snake):
        ...
        window.after(SPEED, next_turn, snake, food)  # to start next turn
